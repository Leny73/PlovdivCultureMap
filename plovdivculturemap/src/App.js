...
class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      locations: [
        {
          title: "The Ancient Theatre of Philippopolis",
          location: { lat: 42.146839, lng: 24.751006 },
        },
        {
          title: "The Ancient Stadium of Philippopolis",
          location: { lat: 42.147568, lng: 24.748018 },
        },
        {
          title: "The Ancient Roman Forum of Philippopolis",
          location: { lat: 42.142111, lng: 24.750944 },
        },
        {
          title: "Bishop's Basilica of Philippopolis",
          location: { lat: 42.144118, lng: 24.752732 },
        },
        {
          title: "Small Basilica of Philippopolis",
          location: { lat: 42.146448, lng: 24.757944 },
        },
        {
          title: "Old Town Plovdiv - Architectural-History Reserve ",
          location: { lat: 42.149824, lng: 24.752665 },
        },
      ],
      placeMarkers: [],
    };
      ...
      geocoder.geocode(
        ...
        (results, status) => {
          if (status === window.google.maps.GeocoderStatus.OK) {
            ...
            window.alert(
              "We couldn't find that location - try entering more specific one"
            );
          }
        }
      );
        ...
        if (status === window.google.maps.StreetViewStatus.OK) {
          ...
          infowindow.setContent(
            '<div style="width:300px;height:30px">' +
              marker.title +
              '</div><div style="width:300px;height:200px"id="pano"></div>'
          );
